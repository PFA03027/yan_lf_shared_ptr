...
{
	// Arrange
	using target_pointer                      = std::allocator_traits<lfheap::typed_pool_heap2<int>>::pointer;
	...
	std::cout << "Watermark after high load: " << lfheap::typed_pool_heap2<int>::get_watermark() << std::endl;
	EXPECT_LT( lfheap::typed_pool_heap2<int>::get_watermark(), lfheap::typed_pool_heap2<int>::NUM );
}
