...
#include "yan_shared_ptr_lf_queue.hpp"
...
TEST( TestRcLimitedLfSharedPtrQueue, Empty_CanPushPopHighload )
{
	...
	EXPECT_LT( lfheap::fixedarray_heap<NonTrivialType>::get_watermark(), que_contents_heap_type::NUM );
	EXPECT_LT( lfheap::fixedarray_heap<NonTrivialType>::get_watermark(), que_node_heap_type::NUM );
}
#endif
