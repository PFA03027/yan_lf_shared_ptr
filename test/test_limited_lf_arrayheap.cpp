...
protected:
	void SetUp() override
	{
		...
		lfheap::limited_arrayheap<int>::debug_destruction_and_regeneration();
	}
...
TEST_F( RcLimitedArrayHeapWithTrivialType, FreeListIsEmpty_CanAllocate_ThenReturnNonNullptr )
{
	...
	// Act
	auto* p_elem = lfheap::limited_arrayheap<int>::allocate();
...
TEST_F( RcLimitedArrayHeapWithTrivialType, FreeListIsNotEmpty_CanAllocate_ThenReturnNonNullptr )
{
	...
	// Act
	auto* p_sut = lfheap::limited_arrayheap<int>::allocate();
